...
require('lazy').setup {
  ...
  -- Indent line for code blocks
  {
    ...
    opts = {
      indent = {
        ...
        indent = {
          enabled = true, -- show all indent guides
          only_current = true, -- only in current window
          only_scope = false, -- DO NOT restrict to scope, show all indents
        },
        scope = {
          enabled = true,
        ...
        -- optional: disable for certain buffers/filetypes
        filter = function(buf)
  ...
  -- Tree-sitter
  {
    ...
    opts = {
      ensure_installed = { 'go', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query' },
